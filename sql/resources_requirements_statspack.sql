----------------------------------------------------------------------------------------
--
-- File name:   resources_requirements_statspack.sql
--
...
--
SET TERM OFF
SET ECHO OFF FEED OFF VER OFF HEA ON PAGES 100 COLSEP ' ' LIN 32767 TRIMS ON TRIM ON TI OFF TIMI OFF ARRAY 100 NUM 10 SQLBL ON BLO . RECSEP OFF;
...
HOS zip -mT esp_requirements_&&rr_host_name_short..zip res_requirements_stp_&&rr_host_name_short._&&ecr_collection_key..txt >/dev/null

UNDEF useappend
UNDEF rr_host_name_short ecr_collection_key