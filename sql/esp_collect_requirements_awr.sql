...
HOS zip -mT esp_requirements_&&esp_host_name_short..zip esp_requirements_&&esp_host_name_short..csv >/dev/null

UNDEF skip_on_10g ecr_sq_fact_hints ecr_date_format
